...
namespace app{	
	...
	*/	
	const PATH = '/lonabmobile/';
	const DOCUMENT_ROOT = '/var/www/html'; //C:/Program Files (x86)/EasyPHP/data/localweb
	const APP_URL_BASE = 'http://192.168.1.20/lonabmobile/';
	const RUNNING_APP = 'lonabmobile';
}
